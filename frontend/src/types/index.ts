...
export interface ExtractedData { image_data?: string; extracted_foods?: ExtractedFood[]; extracted_exercises?: ExtractedExercise[]; daily_analysis?: Record<string, unknown> }
...
export interface MealLog { id?: number; name: string; meal_type?: string; calories: number; protein_g?: number; carbs_g?: number; fat_g?: number; quantity_description?: string; quantity_grams?: number; nutrition_source?: string; occurred_at?: string; created_at?: string }
