          ...
          >
            <div className="flex items-center justify-between p-4 pt-[env(safe-area-inset-top)]">
              <div className="flex items-center gap-2">
                <img src="/logo-nobg.png" alt="FitnessChat" className="h-5 w-5 object-contain" style={{ filter: 'brightness(0) saturate(100%) invert(34%) sepia(88%) saturate(1250%) hue-rotate(199deg) brightness(97%) contrast(106%)' }} />
